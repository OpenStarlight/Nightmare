...
Nightmare 是一个基于 Fabric 的 Minecraft 26.1.2 生存难度提升模组，灵感来自 MITE。项目目标是重写生存早期流程、工具/矿物等级、玩家成长、掉落、食物、世界生成和部分原版系统，使游戏整体更慢、更硬核。
...
- `C:\Users\Stars\.gradle\caches\modules-2\files-2.1\net.fabricmc.fabric-api\fabric-api\0.151.0+26.1.2\e1fc71eedbe51676d2cb8d53dbcc5deaaf3519b8\fabric-api-0.151.0+26.1.2-sources.jar`
  - 优先查这个 sources jar，适合确认 Fabric API 事件、回调接口、方法签名和用法。
- `C:\Users\Stars\.gradle\caches\modules-2\files-2.1\net.fabricmc.fabric-api\fabric-api\0.151.0+26.1.2\f44f652ecb5e95d20d67aa6e49a312c058a4de09\fabric-api-0.151.0+26.1.2.jar`
...
```bash
javap -classpath "C:\Users\Stars\.gradle\caches\fabric-loom\minecraftMaven\net\minecraft\minecraft-common-deobf\26.1.2\minecraft-common-deobf-26.1.2.jar" -private net.minecraft.world.level.block.state.BlockBehaviour
```
